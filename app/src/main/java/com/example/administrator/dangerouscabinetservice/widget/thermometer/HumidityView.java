package com.example.administrator.dangerouscabinetservice.widget.thermometer;
...
public class HumidityView extends View {
    ...
    public HumidityView(Context context, HumidityView.HumidityBuilder builder) {
        super(context);
    ...
    private void drawScaleTitleText(Canvas canvas) {
        ...
        mTextPaint.setTextSize(unitTextSize);
        canvas.drawText("RH%", rightTitleX, titleY, mTextPaint);
    }
...
//        drawLeft(canvas);
    ...
    public static class HumidityBuilder {
        ...
        public HumidityBuilder(Context context) {
            this.context = context;
        }

        public HumidityView.HumidityBuilder setViewBg(int viewBg) {
            this.viewBg = viewBg;
            return this;
        }

        public HumidityView.HumidityBuilder setUnitTextSize(float unitTextSize) {
            this.unitTextSize = unitTextSize;
            return this;
        }

        public HumidityView.HumidityBuilder setUnitTextColor(int unitTextColor) {
            this.unitTextColor = unitTextColor;
            return this;
        }

        public HumidityView.HumidityBuilder setScaleTextSize(float scaleTextSize) {
            this.scaleTextSize = scaleTextSize;
            return this;
        }

        public HumidityView.HumidityBuilder setScaleTextColor(int scaleTextColor) {
            this.scaleTextColor = scaleTextColor;
            return this;
        }

        public HumidityView.HumidityBuilder setMaxScaleLineColor(int maxScaleLineColor) {
            this.maxScaleLineColor = maxScaleLineColor;
            return this;
        }

        public HumidityView.HumidityBuilder setMidScaleLineColor(int midScaleLineColor) {
            this.midScaleLineColor = midScaleLineColor;
            return this;
        }

        public HumidityView.HumidityBuilder setMinScaleLineColor(int minScaleLineColor) {
            this.minScaleLineColor = minScaleLineColor;
            return this;
        }

        public HumidityView.HumidityBuilder setScaleLineWidth(float scaleLineWidth) {
            this.scaleLineWidth = scaleLineWidth;
            return this;
        }

        public HumidityView.HumidityBuilder setMaxLineWidth(float maxLineWidth) {
            this.maxLineWidth = maxLineWidth;
            return this;
        }

        public HumidityView.HumidityBuilder setMidLineWidth(float midLineWidth) {
            this.midLineWidth = midLineWidth;
            return this;
        }

        public HumidityView.HumidityBuilder setMinLineWidth(float minLineWidth) {
            this.minLineWidth = minLineWidth;
            return this;
        }

        public HumidityView.HumidityBuilder setSpaceScaleWidth(float spaceScaleWidth) {
            this.spaceScaleWidth = spaceScaleWidth;
            return this;
        }

        public HumidityView.HumidityBuilder setThermometerBg(int thermometerBg) {
            this.thermometerBg = thermometerBg;
            return this;
        }

        public HumidityView.HumidityBuilder setThermometerShadowBg(int thermometerShadowBg) {
            this.thermometerShadowBg = thermometerShadowBg;
            return this;
        }

        public HumidityView.HumidityBuilder setMaxThermometerRadius(float maxThermometerRadius) {
            this.maxThermometerRadius = maxThermometerRadius;
            return this;
        }

        public HumidityView.HumidityBuilder setMinThermometerRadius(float minThermometerRadius) {
            this.minThermometerRadius = minThermometerRadius;
            return this;
        }

        public HumidityView.HumidityBuilder setMaxMercuryRadius(float maxMercuryRadius) {
            this.maxMercuryRadius = maxMercuryRadius;
            return this;
        }

        public HumidityView.HumidityBuilder setMinMercuryRadius(float minMercuryRadius) {
            this.minMercuryRadius = minMercuryRadius;
            return this;
        }

        public HumidityView.HumidityBuilder setLeftMercuryBg(int leftMercuryBg) {
            this.leftMercuryBg = leftMercuryBg;
            return this;
        }

        public HumidityView.HumidityBuilder setRightMercuryBg(int rightMercuryBg) {
            this.rightMercuryBg = rightMercuryBg;
            return this;
        }

        public HumidityView.HumidityBuilder setLeftMercuryColor(int leftMercuryColor) {
            this.leftMercuryColor = leftMercuryColor;
            return this;
        }

        public HumidityView.HumidityBuilder setRightMercuryColor(int rightMercuryColor) {
            this.rightMercuryColor = rightMercuryColor;
            return this;
        }

        public HumidityView.HumidityBuilder setMaxScaleValue(float maxScaleValue) {
            this.maxScaleValue = maxScaleValue;
            return this;
        }

        public HumidityView.HumidityBuilder setMinScaleValue(float minScaleValue) {
            this.minScaleValue = minScaleValue;
            return this;
        }

        public HumidityView.HumidityBuilder setCurScaleValue(float curScaleValue) {
            this.curScaleValue = curScaleValue;
            return this;
        }

        public HumidityView builder() {
            return new HumidityView(context, this);
        }
